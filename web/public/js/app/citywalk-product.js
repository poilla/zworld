	...
	function getProduct () {
		function handler (data) {
			data.forEach(function (elem, index) {
				...
				var browernum = $('<span class="browernum num">'+elem.browseCount+'</span>次浏览');
				var buynum = $('<span class="buynum num">'+elem.soldCount+'</span>件已售');
				...
				var newPrice = $('<span class="newprice">'+elem.newPrice+'</span> 元起');
				var timeBuy = $('<div class="timebuy"><a href="#" class="buy">立即订购</a></div>');
				
				proPrice.append(oldPrice).append(newPrice);
				browerinfo.append(browernum).append(buynum);
